      ...
      <main className="flex-1 pt-20 pb-24">
        <Container className="py-8">
          ...
          {isLoading ? (
            ...
            <div className="text-center text-red-300">購入履歴の読み込みに失敗しました</div>
                  ...
                  <Card hover variant="glass">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <span
                          className={`glass-badge inline-block mt-2 border ${
            ...
            <div className="text-center text-white/50 py-16">購入履歴はありません</div>
          )}
        </Container>
      </main>
    </>
